    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2
              className="text-4xl md:text-5xl font-black mb-4 text-gray-800 relative"
              style={{ fontFamily: '"Bubblegum Sans", cursive' }}
            >
              What is{' '}
              <span className="text-brand-green-500 relative inline-block group">
                Fittr Kids
              </span>
              ?
            </h2>
          ...
          {/* Features Box */}
          <div
            className={`bg-gray-50 border border-gray-200 rounded-3xl p-8 md:p-12 mb-16 shadow-xl hover:shadow-2xl transition-all duration-500 transform ${
              isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            } hover:scale-[1.02]`}
          >
            <p className="text-lg md:text-xl text-black leading-relaxed mb-8">
              <strong className="text-brand-green-500 relative">Fittr Kids</strong> is a
              health-first initiative designed to build stronger, healthier habits for
              children through fun fitness and simple nutrition. Our mission is to make
              wellness part of everyday family life — without pressure, punishment, or
              guilt.
            </p>
          ...
          >
            <h3
              className="text-3xl md:text-4xl font-black text-black relative"
              style={{ fontFamily: '"Bubblegum Sans", cursive' }}
            >
              Why It Matters{' '}
