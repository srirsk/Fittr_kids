...
const FittrTrustBanner: React.FC = () => {
  return (
    <section
      ...
      className="relative mx-auto mb-12 max-w-3xl overflow-hidden rounded-3xl border border-gray-200 bg-gray-50 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.01]"
    >
      {/* Powered by band */}
      ...
      <div className="px-6 pb-6 pt-10 md:px-8 md:pt-12">
        ...
        <ul className="mt-4 space-y-4">
          {[
            ...
            >
              <CheckCircle className="mt-0.5 w-5 h-5 text-brand-green-500 flex-none" aria-hidden="true" />
